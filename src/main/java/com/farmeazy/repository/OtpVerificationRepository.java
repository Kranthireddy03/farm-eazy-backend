...
public interface OtpVerificationRepository extends JpaRepository<OtpVerification, Long> {
    ...
    java.util.List<OtpVerification> findByEmailAndPurposeAndVerifiedFalse(String email, String purpose);
    ...
    java.util.List<OtpVerification> findByPhoneAndPurposeAndVerifiedFalse(String phone, String purpose);
